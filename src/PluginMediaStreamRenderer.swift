...
class PluginMediaStreamRenderer : NSObject, RTCEAGLVideoViewDelegate {
    ...
    init(
        ...
        eventListener: (data: NSDictionary) -> Void
            ...
            self.webView.backgroundColor = UIColor.clearColor() //UIColor(red: 255, green: 0, blue: 0, alpha: 0.5)
            //var parentView: UIView = self.webView.get
            ...
            //Adding the Video element view as the sibling of webview
